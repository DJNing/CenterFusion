        ...
        if sensor_name in USED_SENSOR:
          ...
          for box in boxes:
            ...
            ann = {
              ...
              'dim': [box.wlh[2], box.wlh[0], box.wlh[1]], # height, width, length, same as kitti
              'location': [box.center[0], box.center[1], box.center[2]], # same as kitti
              'depth': box.center[2],
              'occluded': 0,
              'truncated': 0,
              'rotation_y': yaw,
...
SCENE_SPLITS = {
'train':
    ['scene-'+str(i).zfill(4) for i in range(20)],
'val':
    ['scene-'+str(i+30).zfill(4) for i in range(20)],
'mini_train':
    ['scene-0061', 'scene-0553', 'scene-0655', 'scene-0757', 'scene-0796', 'scene-1077', 'scene-1094', 'scene-1100'],
'mini_val':
    ['scene-0103', 'scene-0916'],
